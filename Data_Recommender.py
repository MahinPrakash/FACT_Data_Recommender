...
if st.button("Send") and user_prompt.strip():
  ...
  url = 'https://tv7ivxm7auhsmkitr3ycuimxi40tberd.lambda-url.us-east-1.on.aws/'
  ...
  st.subheader("✅ Recommended Datasets & Columns")
  st.json(response.get("data_recommendation"))

  st.subheader("📌 Recommendation Reason")
  st.info(response.get("recommendation_reason"))

  st.subheader("Analysis Summary")
  st.info(response.get("analysis_summary"))
